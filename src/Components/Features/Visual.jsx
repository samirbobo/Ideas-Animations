...
const Visual = ({ children, id }) => {
  return (
    <div
      className={`visual-${id} fixed inset-0 flex justify-center items-center pointer-events-none opacity-0`}
    >
...
export const MusicVisual = ({ id }) => {
  ...
  return (
    <Visual id={id}>
      <img className="max-h-[650px]" src="window-spotify.webp" alt="images" />
      {isFullScreen && (
        <motion.div
          layoutId="spotify-logo"
          className="absolute w-[10px] h-48 shadow-lg top-[53%] left-[60.3%] rounded-[10px] bg-[#1bd761] p-[1px]"
        >
